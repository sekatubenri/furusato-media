...
const SITE = { name: 'ふるさと納税ナビ', url: 'https://furusato-media.vercel.app' };
const AFFILIATE_TOP = `
<div style="background:#f0fdf4;border:2px solid #16a34a;border-radius:8px;padding:16px;margin:24px 0;">
  <p style="font-weight:bold;color:#15803d;margin:0 0 8px;">【PR】おすすめふるさと納税サイト</p>
  <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:8px;">
    <li><a href="//ck.jp.ap.valuecommerce.com/servlet/referral?sid=3775267&pid=892655303" rel="nofollow" style="display:inline-block;background:#ff0033;color:#fff;padding:10px 20px;border-radius:6px;text-decoration:none;font-weight:bold;">▶ Yahoo!ショッピング ふるさと納税（ポイント還元でお得）</a><img src="//ad.jp.ap.valuecommerce.com/servlet/gifbanner?sid=3775267&pid=892655303" height="1" width="1" border="0" alt=""></li>
...
<div style="background:#fffbeb;border:2px solid #d97706;border-radius:8px;padding:16px;margin:24px 0;">
  <p style="font-weight:bold;color:#92400e;margin:0 0 12px;">📚 節税・ふるさと納税の参考書</p>
  <ul style="list-style:none;padding:0;margin:0;">
    <li><a href="https://www.amazon.co.jp/s?k=%E3%81%B5%E3%82%8B%E3%81%95%E3%81%A8%E7%B4%8D%E7%A8%8E&linkCode=ll2&tag=mirainikibouw-22" rel="nofollow" target="_blank" style="color:#1d4ed8;text-decoration:underline;">▶ ふるさと納税関連書籍【Amazon】</a></li>
  </ul>
</div>`;
async function generateArticle() {
  ...
  const message = await client.messages.create({
    ...
    messages: [{ role: 'user', content: `あなたはふるさと納税メディア「${SITE.name}」の専門ライターです。以下のJSON形式のみで出力してください:\n{"title":"タイトル(40〜60文字)","description":"説明(120文字以内)","category":"${topic.category}","date":"${today}","content":"HTMLコンテンツ"}\nトピック:${topic.title}\ncontent要件:1500文字程度のHTML、h2×3〜5個、ul/table活用、具体的な金額・手順含む、JSON全体を必ず完結させる` }],
  });
